...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        account01.setEmail("smilexah@inbox.ru");
        account01.setPassword("user");
        account01.setFirstname("User");
        account01.setLastname("Userovich");
        account01.setAge(25);
        account01.setDateOfBirth(LocalDate.parse("1990-07-07"));
        account01.setGender("Male");

        account02.setEmail("admin@inbox.ru");
        account02.setPassword("admin");
        account02.setFirstname("Admin");
        account02.setLastname("Adminovich");
        account02.setRole(Roles.ADMIN.getRole());
        account02.setAge(25);
        account02.setDateOfBirth(LocalDate.parse("1990-07-07"));
        account02.setGender("Male");

        account03.setEmail("editor@inbox.ru");
        account03.setPassword("editor");
        account03.setFirstname("Editor");
        account03.setLastname("Editorovich");
        account03.setRole(Roles.EDITOR.getRole());
        account03.setAge(64);
        account03.setDateOfBirth(LocalDate.parse("1687-07-07"));
        account03.setGender("Male");

        account04.setEmail("super_editor@inbox.ru");
        account04.setPassword("editor");
        ...
        account04.setAge(55);
        account04.setDateOfBirth(LocalDate.parse("1965-07-07"));
        ...
        if (posts.size() == 0) {
            ...
            post04.setTitle("Spring Boot Model–view–controller framework");
            post04.setBody("""
            ...
            post05.setTitle("Spring Boot Model–view–controller framework");
            post05.setBody("""
            ...
            post06.setTitle("Spring Boot Model–view–controller framework");
            post06.setBody("""
